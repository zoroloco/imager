...
var App = /** @class */ (function () {
    ...
    App.prototype.processSourceDest = function (imageGroupId) {
        ...
        fs.readdir(conf_json_1.default.sourceDir, function (err, files) {
            ...
            logger_1.Logger.info(files.length + " total files found in src directory:" + conf_json_1.default.sourceDir);
            ...
            if (!_.isEmpty(files)) {
                ...
                logger_1.Logger.info(conf_json_1.default.sourceDir + ' did not contain any files.');
                _this.emitter.emit(ImagerEvents.DONE);
            }
        });
    };
