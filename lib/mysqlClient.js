...
var MySqlClient = /** @class */ (function () {
    function MySqlClient() {
        ...
        this.connection.connect(function (err) {
            ...
            logger_1.Logger.info('Connected to MYSQL db:' + conf_json_1.default.mysql.host + ' as id ' + _this.connection.threadId);
        });
    }
    ...
    MySqlClient.prototype.query = function (queryStr) {
        var _this = this;
        logger_1.Logger.debug('Executing query:' + queryStr);
        return new Promise(function (resolve, reject) {
            _this.connection.query({ sql: queryStr, timeout: 60000 }, function (err, rows) {
                ...
                logger_1.Logger.debug('Successfully retrieved: ' + rows.length + ' rows.');
                resolve(rows);
            });
        });
    };
