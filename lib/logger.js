                ...
                fileLogger = winston_1.default.createLogger({
                    ...
                    transports: [
                        new winston_1.default.transports.File({
                            filename: path_1.default.join(conf_json_1.default.logger.dir, conf_json_1.default.title + '-' + dateStamp.getUTCDate() + '-' + (dateStamp.getUTCMonth() + 1) + '-' + dateStamp.getUTCFullYear() + '.log'),
                            maxFiles: 256,
                            maxsize: 4194304,
